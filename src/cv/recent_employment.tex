...
\cventry
  {Software Engineer (Machine Learning)} % Job title
  {Adelaide MRI} % Organization
  {} % Location
  {2020 - 2021} % Date(s)
{%
...
\cventry
    {eResearch Trainer, eResearch Training Administrator} % Job title
