...
\section{Interests}
\cvlistitem{\textbf{Photography/Videography} -- The documentation of events and performances through visual mediums.}
\cvlistitem{\textbf{Systems Administration} -- Managing a number of servers running production systems for my personal use,
including the storage and backup of large volumes of my personal photographs and videos}
\cvlistitem{\textbf{Information Security} -- A practical interest in the digital and physical security of data,
from the appropriate use of authentication, to the sanitisation of database inputs.}
